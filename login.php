...
<head>
     <!-- Title Meta -->
     <meta charset="utf-8" />
     <title>Sign In | Restaurant POS System</title>
                              ...
                              <div class="card-body">
                                   <div class="p-3">
                                        ...
                                        <div class="p-3">
                                             ...
                                             <?php endif; ?>
                                             <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" class="authentication-form">                                                                                               
                                                  <div class="mb-4">
                                                       <label class="form-label" for="UserEmail">Email</label>
                                                       <div class="position-relative w-100">
                                                            <input type="email" class="form-control form-control-lg rounded" id="UserEmail" name="email" placeholder="Enter Email" value="<?php echo htmlspecialchars($email); ?>" required>
...
<!-- Mirrored from foxpixel.vercel.app/metor/auth-signin.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 10 Sep 2025 08:08:36 GMT -->
</html>